...
## Environments
- Preview: https://main--AdobeCommerce--prithwirajdeb.aem.page/
- Live: https://main--AdobeCommerce--prithwirajdeb.aem.live/
...
1. Open the `AdobeCommerce` directory in your favorite IDE and start coding :)
